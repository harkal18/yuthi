import SendPostRequestModule = require("../utils/SendPostRequest");
...
export class Post {
    ...
    init(url: string, params: string): void {
        ...
        let sendPostRequest = new SendPostRequestModule.SendPostRequest();
